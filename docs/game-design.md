...
- A rota autoritativa sorteia de 4 a 8 turnpoints (`TP1` em diante), seguidos de `GOL`. Exatamente dois TPs aleatorios ficam contra o vento, com pernas mais curtas entre 1,5 e 3 km; as demais pernas ficam no semiplano favoravel e medem entre 5 e 10 km. A geracao considera a variacao dinamica para preservar essas relacoes durante a prova. Ao cruzar o raio do checkpoint em ordem, o participante recebe bonus fixo mais bonus de tempo; completar a rota sinaliza `GOL` no HUD.
