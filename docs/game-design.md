...
## HUD mobile
Em telas estreitas o instrumento vira uma faixa compacta no topo distribuida em blocos: linha de status/tempo, card do vario, cards curtos para altura sobre o solo e velocidade, e uma linha dedicada para pontuacao, combo e proximo waypoint com a distancia ate ele. A altitude sobre o nivel do mar, o vento, a fita de bussola, o planeio e a distancia desde a decolagem ficam ocultos. O ranking fica oculto durante o voo no mobile e reaparece quando a rodada termina para nao competir com a cena 3D e os controles touch. O painel inicial fica no canto superior da tela no mobile, afastado dos controles touch inferiores.
